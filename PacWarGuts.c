...
void ScoreDuel( PacGenePtr g1, PacGenePtr g2, 
	      int *rounds, int *score1, int *score2 ) {
    World w[2];
    int round = 0;
    int count[2] = {1,1};
    int order = 0;
    ...
    *rounds = round;
    ...
    if (count[1]==0){
    	...
    	else if (round<200 && round>99){
    		*score1=19;
    		*score2=1;
    	}
    	else if (round>199 && round<300){
    		*score1=18;
    		*score2=2;
    	}
    	else if (round>=300 && round<=500){
    		*score1=17;
    		*score2=3;
    	}
   		return;
    ...
    if((float)count[0]/count[1]>=10.0){
    	*score1=13;
    	*score2=7;
    	return;
    }
    if((float)count[0]/count[1]>3.0 && (float)count[0]/count[1]<10.0){
    	*score1=12;
    	*score2=8;
    	return;
    }
    
    if((float)count[0]/count[1]>1.5 && (float)count[0]/count[1]<3.0){
    	*score1=11;
    	*score2=9;
    	return;
    }
    ...
    if((float)count[1]/count[0]>=10.0){
    	*score2=13;
    	*score1=7;
    	return;
    }
    if((float)count[1]/count[0]>3.0 && (float)count[1]/count[0]<10.0){
    	*score2=12;
    	*score1=8;
    	return;
    }
    
    if((float)count[1]/count[0]>1.5 && (float)count[1]/count[0]<3.0){
    	*score2=11;
    	*score1=9;
    	return;
    }
