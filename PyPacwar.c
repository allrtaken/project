...
static PyObject *scorebattle_PyPacwar(PyObject *self, PyObject *args);

static PyMethodDef module_methods[] = {
    {"battle", battle_PyPacwar, METH_VARARGS, battle_docstring},
    {"scorebattle", scorebattle_PyPacwar, METH_VARARGS, battle_docstring},
    {NULL, NULL, 0, NULL}
};
...
static PyObject *scorebattle_PyPacwar(PyObject *self, PyObject *args)
{
    ...
    SetGeneFromString(g1_str, gp[0]);
    SetGeneFromString(g2_str, gp[1]);
    ScoreDuel(gp[0],gp[1],&numrounds,&count[0],&count[1]);
